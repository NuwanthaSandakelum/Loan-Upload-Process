create or replace procedure sp_st_loan_upload_man
(
 P_month     varchar2
)
as
...
---- select seq_loan_run_id.nextval into v_run_id from dual;
...
BEGIN
ST_SP_Loan_Details_X2(null,C_MAIN.BANK_ID, C_SUB.LOAN_ID, V_FROM_DATE, V_TO_DATE ); -- for other months
